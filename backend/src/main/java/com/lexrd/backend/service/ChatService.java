...
public class ChatService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            Si el CONTEXTO LEGAL no menciona plazos, fechas, montos o procedimientos exactos para responder una parte de la pregunta, ESTÁ ESTRICTAMENTE PROHIBIDO que intentes deducirlos, adivinarlos o usar tu conocimiento general previo. En ese caso, responde ÚNICAMENTE: "El texto legal recuperado no especifica esta información, por favor consulte a un abogado". ¡Cero excepciones!
