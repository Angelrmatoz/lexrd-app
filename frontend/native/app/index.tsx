        ...
        <SafeAreaView className="flex-1 bg-[#131313]">
                    ...
                    <View className="items-end w-full">
                        <View className="bg-[#353534] px-4 py-3 rounded-xl max-w-[85%]">
                            <Text className="text-[#e5e2e1] text-[15px] leading-relaxed">
                                ¿Cuáles son los requisitos para la deducción de gastos educativos en el impuesto sobre
                                la renta?
                            </Text>
                        </View>
                    ...
                    <View className="w-full">
                        ...
                        <View className="gap-y-4">
                            <Text className="text-[#e5e2e1] text-[16px] leading-[1.6]">
                                Para la deducción de gastos educativos en la República Dominicana, de acuerdo con la
                                normativa vigente, se deben cumplir los siguientes criterios fundamentales:
                            </Text>

                            <View className="pl-1 gap-y-3">
                                <View className="flex-row gap-x-3">
                                    <Text className="text-[#abc7ff] font-bold">01.</Text>
                                    <Text className="text-[#e5e2e1] flex-1">Estar registrado como contribuyente y estar
                                        al día con sus obligaciones fiscales.</Text>
                                </View>
                                <View className="flex-row gap-x-3">
                                    <Text className="text-[#abc7ff] font-bold">02.</Text>
                                    <Text className="text-[#e5e2e1] flex-1">Los gastos deben corresponder a la educación
                                        propia o de dependientes directos no asalariados.</Text>
                                </View>
                                <View className="flex-row gap-x-3">
                                    <Text className="text-[#abc7ff] font-bold">03.</Text>
                                    <Text className="text-[#e5e2e1] flex-1">Contar con comprobantes fiscales válidos
                                        (NCF) emitidos por entidades educativas reconocidas.</Text>
                                </View>
                            </View>

                            <Text className="text-[#e5e2e1] text-[16px] leading-[1.6]">
                                El límite de la deducción es el 10% del ingreso gravado o el 25% del exento, lo que
                                resulte menor.
                            </Text>
                        </View>
                        ...
                        <View className="flex-row flex-wrap mt-6 gap-2">
                            <View
                                ...
                                <Text className="text-[11px] font-medium text-[#abc7ff] tracking-tight">Ley
                                    179-09</Text>
                            </View>
                            <View
                                className="bg-[#0e0e0e] border border-[#44474826] px-3 py-2 rounded-lg flex-row items-center gap-x-2">
                                <Gavel size={14} color="#abc7ff"/>
                                <Text className="text-[11px] font-medium text-[#abc7ff] tracking-tight">Art. 42 Cód.
                                    Tributario</Text>
                            </View>
                        </View>
                    </View>
            ...
            <View className="bg-[#131313] pb-4">
                ...
                <View className="px-5 mb-4">
                    <View
                        className="flex-row items-center bg-[#0e0e0e] rounded-full border border-[#4447481a] px-2 py-2">
                        <TextInput
                        ...
                        />
                        <Pressable
                            className="bg-[#c6c6c7] w-10 h-10 rounded-full items-center justify-center active:scale-95">
