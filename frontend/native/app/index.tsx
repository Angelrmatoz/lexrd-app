                    ...
                    {messages.length === 0 && !isLoading ? (
                        <View className="flex-1 justify-center items-center space-y-6 -mt-10">
                            ...
                            <View className="items-center px-4 pt-4">
                                <Text className="text-[28px] font-extrabold text-[#e5e2e1] text-center mb-3 leading-tight">
                                    Tu Asistente Legal Digital
                                </Text>
                                <Text className="text-[#c4c7c7] text-[15px] text-center max-w-[90%] leading-relaxed">
                                    Análisis legal dominicano experto, inteligencia regulatoria y jurisprudencia al alcance de tu mano.
                                </Text>
                            </View>
                        </View>
                    ) : (
                                            ...
                                            <View className="flex-row flex-wrap mt-6 gap-2">
                                                {msg.sources.map((source, sIndex) => (
                                                    <View
                                                        ...
                                                        <Text className="text-[11px] font-medium text-[#abc7ff] tracking-tight">
                                                            {source}
                                                        </Text>
                                                    </View>
                                                ))}
