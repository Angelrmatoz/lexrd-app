            ...
            >
                <View className="space-y-8 gap-y-8">
                    ...
                    <View className="items-center">
                        ...
                        <Text
                            className="text-3xl font-black tracking-tighter uppercase text-center text-[#e5e2e1] mb-2">
                            Biblioteca <Text className="text-[#EF3340]">Digital</Text>
                        </Text>
                        <Text
                            className="text-3xl font-black tracking-tighter uppercase text-center text-[#e5e2e1] mb-2">
                            DE <Text
                            className="text-3xl font-black tracking-tighter uppercase text-center text-[#0034BB] mb-4">
                            Jurisprudencia
                        </Text>
                        </Text>
